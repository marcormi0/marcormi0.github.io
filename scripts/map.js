document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ship data
    const ships = [
      { name: "Freedom Flotilla I", homePort: "Barcelona", status: "sailing", progress: 94, emoji: "🚢" },
      { name: "Solidarity Ship", homePort: "Genoa", status: "sailing", progress: 83, emoji: "⛵" },
      { name: "Hope Vessel", homePort: "Tunis", status: "sailing", progress: 82, emoji: "🛥️" },
      { name: "Peace Carrier", homePort: "Siracusa", status: "sailing", progress: 70, emoji: "🚤" }
    ];
    ...
    const createRealisticRoute = (startPortName) => {
      ...
      const routes = {
        "Barcelona": [
          ...
          [35.5, 18.5], [34.89, 24.26], [34.85, 26.16], [31.5105, 34.4069]],
        "Genoa": [[44.4056, 8.9463], [42.0, 10.5], [39.5, 13.5], [38.28, 15.68], [38.23, 15.61], [37.49, 15.11], 
        [37.0, 16.0], [35.2, 20.0], [34.87, 24.76], [34.85, 26.16], [31.5105, 34.4069], [31.5105, 34.4069]],
        "Tunis": [[36.8099  , 10.3], [36.79, 10.35], [37.09, 10.69], [37.10, 11.05], [37.0, 12.0], [36.76, 14.5], [35.5, 18.5], 
        [34.89, 24.26], [34.85, 26.16], [32.0, 32.0], [31.5105, 34.4069]],
        "Siracusa": [[37.0668, 15.2907], [36.0, 18.0], [35.28, 21.30], [34.87, 24.79], [34.85, 26.16], 
        [32.0, 31.5], [31.5105, 34.4069]]
      };
